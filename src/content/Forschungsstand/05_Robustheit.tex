...
\end{table} % Weißt du wie es dein Betreuer an der Hochschule mit englischen Begriffen hält? Müssen die übersetzt werden?
...
Unterschiede in den Umgebungen können bspw. durch fixe Dynamiken wie z. B. Reibwerte während des Trainingsprozesses und unterschiedlicher Reibwerte während der Testphase realisiert werden. \footcite[Vgl.][S. 6]{Pinto.2017} % wie z.B. durch voneinanderabweichenden Reibwerten während des Trainingsprozesses und der Testphase realisiert werden.
