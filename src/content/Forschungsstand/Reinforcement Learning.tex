...
Der Agent im Kontext von modellfreien RL Methoden nur die Zustände $S$ und die Aktionen $A$, jedoch nicht die Umgebungsverhalten $T$ und die Belohnungswahrscheinlichkeit $R$. \footcite[Vgl.][S. 2]{Cutler.2014}
...
\begin{figure}[htb]
    \centering
    \includegraphics[height=4cm]{lib/graphics/taxonomy of RL algorithms.png}
...
Methoden welche die Strategie durch dessen Parametrisierung anstelle einer Wertigkeitsfunktion optimieren werden als strategiebasierend bezeichnet. \footcite[Vgl.][S. 2]{Zhang.2018}
...
\end{description}
Zusammengefasst kann Formel vier und fünf dabei so interpretiert werden, dass die logarithmierte Wahrscheinlichkeit Aktion $a_{t}$ im Zustand $s_{t}$ auszuwählen erhöht werden soll, wenn $a_{t}$ in einer höheren kumumlierten Belohnung resultiert. \footcite[Vgl.][S. 6]{Wang.2020}
...
Trotz signifikanter Errungenschaften bewirkt der Einsatz von den besprochenen RL Algorithmen weiterhin Limitierungen und Risiken für ungewolltes Verhalten. \footcite[Vgl.][S. 7]{Li.2019}
