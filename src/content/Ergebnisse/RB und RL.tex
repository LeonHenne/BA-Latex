...
Dazu werden mehrfach die selben statistischen Signifikanztests durchgeführt, um zum einen den Effekt der DR zu ermitteln.
...
\begin{table}[htb]
    ...
    sum reward & 0.6276673409642575 & 0.6870324210336459 & False & False \\
    \begin{tabular}[c]{@{}l@{}}reward mean \\ difference\end{tabular} & 1.2200477617083057e-22 & 1.0 & True & False \\
    \begin{tabular}[c]{@{}l@{}}count of \\ failures \end{tabular} & 0.1814596593937995 & 0.09072982969689974 & False & True
    \end{tabular}
