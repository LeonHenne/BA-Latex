...
\begin{table}[htb]
    ...
    \begin{tabular}[c]{@{}l@{}}Erzielte kumu- \\lierte Belohnung\end{tabular} & 0.48390799726891964 & 0.7588082897727775 & False & False \\
    \begin{tabular}[c]{@{}l@{}}Abweichung vom \\ Belohnungs- \\Mittelwert\end{tabular} & 2.2302103039562726e-05 & 0.9999889697144758 & True & False \\
    \begin{tabular}[c]{@{}l@{}}Häufigkeit von \\ Misserfolg \end{tabular} & 0.005412977104604817 & 0.0027064885523024086 & True & True
    \end{tabular}
...
Forschungshypothesen und Testhypothesen sind entsprechend dem Vergleich der Policies aus dem Training mit DR und ohne DR anzupassen.
...
% Untersuchungsgegenstand
Mittels der adaptierten zweiten Forschungshypothese wird die Verteilung der Abweichungen vom Mittelwert der Belohnungen über alle 100 Testszenarien untersucht. % die Verteilung der durchschnittlichen Abweichungen?
...
Im zweiten Test wird die Verringerung der Verteilung aus der Verwendung der Strategie mit DR angenommen. % Verringerung der Verteilung = Verringerung der durchschnittlichen Abweichung?

% Evaluation
Tabelle 8 zeigt zum ersten Test der Gleichheit einen P-Wert von in etwa $2.2302e-05$.
Daraus resultierend können nur zu einer sehr geringen Wahrscheinlichkeit per Zufall die Daten aus einer selben unterliegenden Verteilung gezogen worden sein. % Dies bedeutet, dass nur zu einer ... gezogen worden sein können.
...
Folgend kann abgeleitet werden, dass die H0 Hypothese einer stärkeren Verteilung der Abweichungen anzunehmen ist. % stärkere Verteilung der Abweichungen = höhere durchschnittliche Abweichungen / stärkere Streuung der kumulierten Belohnung ?
Entsprechend wird die H1 Hypothese sowie die Hypothese 2 abgelehnt, da die angewendete Form der DR zu einem negativen Effekt auf die Varianz der Belohnungen führt. % Die Varianz ist eigentlich die mittlere quadratische Abweichung, du misst aber die mittlere absolute Abweichung oder?
