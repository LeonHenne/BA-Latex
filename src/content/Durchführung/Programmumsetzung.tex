...
Die Angreiferdrohne wird im ersten Trainingsszenario regelbasiert gesteuert, indem sie sich von ihrem Startpunkt in direkter Fluglinie zum Zielpunkt begibt.
...
\begin{itemize}
    ...
    \item - (Rule based defender) - Done
    \item - Behavioral Cloning Algorithmus - Done 
    \item - Parameter und Prozess - Done
