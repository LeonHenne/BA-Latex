...
\begin{spacing}{1}
  ...
  \input{lib/tables/abkuerzungen.tex}
  \clearpage
...
\input{src/content/Einleitung.tex}
\input{src/content/Forschungstand.tex}
\input{src/content/Durchführung.tex}
\input{src/content/Ergebnisse.tex}
\input{src/content/Reflexion.tex}
